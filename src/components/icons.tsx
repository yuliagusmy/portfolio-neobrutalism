...
export function InstagramIcon({ className, size = 20 }: IconProps) {
  return (
    <svg role="img" width={size} className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
...
export function LinkedInIcon({ className, size = 20 }: IconProps) {
  return (
    <svg role="img" width={size} viewBox="0 0 24 24" className={className} xmlns="http://www.w3.org/2000/svg" fill="currentColor">
